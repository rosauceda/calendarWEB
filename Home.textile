h1. IMPORTANT - Project status.

Due to other commitments, I will no longer be maintaining this project for the foreseeable future. I encourage anyone to fork the project and discuss your fork in the google group if you like. If someone proves to be taking the project to the next level, we can discuss making it the new official version of the plugin.
